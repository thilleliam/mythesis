...
class OptimisateurNavettes:
    ...
    def _analyser_vehicule_demande_partielle(self, demande_restante, vehicule, duree_max_jours):
        ...
        return {
            ...
            'efficacite_utilisation': efficacite_moyenne,  # NOUVEAU
            'proportion_demande_satisfaite': proportion_demande  # NOUVEAU
        }
        return {
            'vehicule': vehicule,
            'nb_voyages_realisables': nb_voyages_realisables,
    ...
    vehicules_algeriens = [
        {
            'nom': 'PLATEAU_4X2',
            'type': 'LEGER',
            'capacite_poids_max': 8.0,      # 8 tonnes
            'capacite_volume_max': 35.0,    # 35 m³
            'vitesse_kmh': 85,
            'cout_fixe_jour': 150,          # Coût fixe modéré
            'cout_variable_km': 280         # 280 DA/km
        },
        {
            'nom': 'PLATEAU_6X6',
            'type': 'TOUT_TERRAIN',
            'capacite_poids_max': 12.0,     # 12 tonnes
            'capacite_volume_max': 45.0,    # 45 m³
            'vitesse_kmh': 75,              # Plus lent (tout-terrain)
            'cout_fixe_jour': 200,          # Coût fixe plus élevé
            'cout_variable_km': 400         # 400 DA/km
        },
        {
            'nom': 'SEMI_REMORQUE_6X4',
            'type': 'LOURD_ROUTIER',
            'capacite_poids_max': 32.0,     # 32 tonnes
            'capacite_volume_max': 85.0,    # 85 m³
            'vitesse_kmh': 80,
            'cout_fixe_jour': 280,          # Coût fixe modéré
            'cout_variable_km': 180         # 180 DA/km - LE PLUS ÉCONOMIQUE
        },
        {
            'nom': 'SEMI_REMORQUE_6X6',
            'type': 'LOURD_TOUT_TERRAIN',
            'capacite_poids_max': 28.0,     # 28 tonnes (un peu moins que 6x4)
            'capacite_volume_max': 80.0,    # 80 m³
            'vitesse_kmh': 70,              # Plus lent (tout-terrain)
            'cout_fixe_jour': 320,          # Coût fixe élevé
            'cout_variable_km': 400         # 400 DA/km
        },
        {
            'nom': 'PORTE_ENGIN_6X4',
            'type': 'SPECIALISE_ROUTIER',
            'capacite_poids_max': 25.0,     # 25 tonnes
            'capacite_volume_max': 60.0,    # 60 m³ (optimisé pour équipements lourds)
            'vitesse_kmh': 75,
            'cout_fixe_jour': 300,          # Coût fixe spécialisé
            'cout_variable_km': 400         # 400 DA/km
        },
        {
            'nom': 'PORTE_ENGIN_6X6',
            'type': 'SPECIALISE_TOUT_TERRAIN',
            'capacite_poids_max': 22.0,     # 22 tonnes
            'capacite_volume_max': 55.0,    # 55 m³
            'vitesse_kmh': 65,              # Le plus lent (spécialisé + tout-terrain)
            'cout_fixe_jour': 350,          # Coût fixe le plus élevé
            'cout_variable_km': 400         # 400 DA/km
        }
    ]
